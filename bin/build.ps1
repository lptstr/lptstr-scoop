...
Set-Content -Path "../APPLIST.md" -Value "# List of apps in bucket`n---`nAutomatically generated by the bin/build.ps1 script`r`n`r`n" -NoNewline
...
Add-Content -Path "../APPLIST.md" -Value "`nThis file was automatically generated."
