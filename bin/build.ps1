...
Set-Content -Path $APPLIST -Value "# List of apps`n---`nAutomatically generated by the bin/build.ps1 script"

Add-Content -Path $APPLIST -Value "| Name | Version |"
Add-Content -Path $APPLIST -Value "| ---- | ------- |"

Get-ChildItem ../.\*.json | Foreach-Object {
	$appname = $_.BaseName
	$appdata = Get-Content $_ | ConvertFrom-JSON
	$version = $appdata.version
	Add-Content -Path $APPLIST -Value "| $basename | $version |`n"
}

Add-Content -Path $APPLIST -Value "`r`nThis file was automatically generated."
