...
#
#   BUCKET MAINTAINERS: This script assumes that the environment
#   variable $env:OPENSCOOPDEVDIR is set to where this repository's 
#   root directory is located. It also assumes that Scoop is
#   installed in $env:USERPROFILE\scoop.
#   
...
$OPENSCOOPDIR = $env:OPENSCOOPDEVDIR
$USER = $env:USERNAME
$APPLIST = "../APPLIST.md"
